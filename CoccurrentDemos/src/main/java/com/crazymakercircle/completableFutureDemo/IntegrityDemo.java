...
public class IntegrityDemo {
    ...
    public void rpcDemo() throws Exception {
        ...
        CompletableFuture<String> future3 = future1.thenCombine(future2, (out1, out2) -> out1 + " & " + out2);
    ...
    public void rxJavaDemo() {
        Observable<String> observable1 = Observable.fromCallable(() -> rpc1())
                                                   .subscribeOn(Schedulers.newThread());
        Observable<String> observable2 = Observable.fromCallable(() -> rpc2())
                                                   .subscribeOn(Schedulers.newThread());
